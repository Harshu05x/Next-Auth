...
const ForgotPasswordPage = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 items-center mx-auto w-10/12">
            <form
                className="flex flex-col gap-2 p-2 border m-2 rounded-md shadow justify-center"
